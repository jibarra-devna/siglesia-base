<template>
  ...
  <h6 class="text-h6"><span class="subtitle text-h6">Libros Parroquiales / </span> <span class="subtitle text-h6">Primeras Comuniones / </span> Agregar Comunión</h6>
...
<v-col cols="12">
  <v-card md="4">
    <v-card-text>
      <v-form>
        <p></p>
        <h3><span style="color: #696cff; vertical-align:1px;">━━━━━━━━━ </span><strong>Datos del Catecúmeno</strong></h3>
        ...
        <v-col cols="12">
          <v-row>
            ...
            <v-col cols="6">
              <VTextField
                label="Hora de Primera Comunión"
                type="time"
                variant="outlined"
              />
            </v-col>
        ...
        <v-col cols="12">
          <v-row>
            ...
            <v-col cols="6">
              <VSelect
                label="Celebrante"
                placeholder="Selecciona un Celebrante"
              />
            </v-col>
          </v-row>
        </v-col>
        <v-col cols="12">
          <v-row>
            <v-col cols="6">
              <VSelect
                label="Como Cura Certifica"
                placeholder="Selecciona un Cura"
              />
            </v-col>
            <v-col cols="6">
              <VTextarea
                ...
                rows="3"
                placeholder="Agregar notas marginales"
                variant="outlined"
              />
            </v-col>
          </v-row>
...
data() {
  return {
    //valores a los campos por medio del v-model
  };
},
};
</script>
