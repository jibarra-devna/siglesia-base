...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'librosparroquiales-bautismos': RouteRecordInfo<'librosparroquiales-bautismos', '/librosparroquiales/bautismos', Record<never, never>, Record<never, never>>,
    'librosparroquiales-confirmaciones': RouteRecordInfo<'librosparroquiales-confirmaciones', '/librosparroquiales/confirmaciones', Record<never, never>, Record<never, never>>,
    'librosparroquiales-matrimonios': RouteRecordInfo<'librosparroquiales-matrimonios', '/librosparroquiales/matrimonios', Record<never, never>, Record<never, never>>,
    'librosparroquiales-primera-comunion': RouteRecordInfo<'librosparroquiales-primera-comunion', '/librosparroquiales/primeraComunion', Record<never, never>, Record<never, never>>,
    'librosparroquiales-resumen': RouteRecordInfo<'librosparroquiales-resumen', '/librosparroquiales/resumen', Record<never, never>, Record<never, never>>,
    'login': RouteRecordInfo<'login', '/login', Record<never, never>, Record<never, never>>,
    'modulos': RouteRecordInfo<'modulos', '/modulos', Record<never, never>, Record<never, never>>,
